...
- Business / positioning context: [AGENTS.md](AGENTS.md) Project Overview + [docs/specs/](docs/specs/)
...
- Respect the repo-wide CSS rules from [AGENTS.md](AGENTS.md): ZERO duplicate CSS, hard CSS budget 1.5k LOC.
...
If the repo has a business plan doc, take it into account. For Deslop, use the Project Overview in [AGENTS.md](AGENTS.md) and the positioning material in [docs/specs/](docs/specs/) as the business context.
...
- **Honor the CSS budget** — ZERO duplicate CSS, stay under the 1.5k LOC cap set in [AGENTS.md](AGENTS.md).
