...
Every duplication count, percentage, weight, rank and category is computed once in the engine. Diagnostic severity is resolved from the shared configuration. Clients display these results; they do not calculate substitutes.
