...
> **Status: shipped.** Pinned by `crates/deslop-core/src/diff_scope/` unit tests, `crates/deslop/tests/diff_scoped_reporting.rs` and `crates/deslop/tests/diff_ingest_refusals.rs`.
