...
#### [FUSED-CANDIDATE-BUCKET-STAR] A structural-hash bucket pairs every member across files
...
### [FUSED-SHARED-SUBTREE-SAME-FILE] A near-miss inside one file is not rescued, and that is a known gap
