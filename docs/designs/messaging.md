...
- **Tree-sitter, not regex.** Four duplication categories — Identical, Nearly identical, Similar, Same behavior — detected through AST fingerprints and embedding fusion, never line-matching.
