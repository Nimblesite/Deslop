...
- P-LANG-0 tree-sitter runtime upgrade to 0.26.8, including modern
  ...
  [lang-roadmap.md §LANG-SHIPPED](lang-roadmap.md#lang-shipped).
...
- [Language roadmap](lang-roadmap.md) — future parser/plugin rollout. P-LANG-0 through P-LANG-4, PHP, F#, and Go (P-LANG-3) are complete; PHP filter parity ([LANG-PHP-WIRING]) is open, and Java is the next planned language slice.
...
- [ ] Close PHP filter parity ([lang-roadmap.md §LANG-PHP-WIRING](lang-roadmap.md#lang-php-wiring)), then continue the [Language roadmap](lang-roadmap.md) with Java (P-LANG-5); Go (P-LANG-3) shipped 2026-07-26.
