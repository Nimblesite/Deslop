...
- [ ] Finish [JetBrains E2E](jetbrains-e2e-plan.md): descriptor wiring tests landed; still need a real Android Studio / IntelliJ launch test asserting native diagnostics on a duplicate fixture against the real `deslop-lsp`, wired into a Make target + CI job.
