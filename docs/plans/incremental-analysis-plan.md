...
| [CLI-ARG-DIFF] + [CLI-ARG-ONLY-CHANGED] | The two flags and their conflicts | ✅ implemented, pinned by `diff_scoped_reporting.rs` 7/7 and `diff_ingest_refusals.rs` 8/8 |
