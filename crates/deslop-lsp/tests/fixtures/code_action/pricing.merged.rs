fn merged_from_cluster_ff0d17(book: &mut Vec<(String, i64)>, arg0: &'static str, arg1: i64) {
    let label = arg0;
    let ceiling = arg1;
...
pub fn apply_standard(book: &mut Vec<(String, i64)>) {
    merged_from_cluster_ff0d17(book, "standard", 100);
}

pub fn apply_premium(book: &mut Vec<(String, i64)>) {
    merged_from_cluster_ff0d17(book, "premium", 250);
}
