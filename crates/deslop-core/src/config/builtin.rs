...
//! the dependency/artefact component lists, the generated-code path
//! rules, and the corpus-scoped path matching they share. Generated
//! files recognised by their banner rather than their path are
//! [`super::generated_banner`]'s ([EXCLUSION-GENERATED-BANNER]). Applied before any
