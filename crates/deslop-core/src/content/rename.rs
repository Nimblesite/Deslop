...
/// The modal bijection and the per-pair corroboration ledger.
mod corroboration;

pub(super) use corroboration::{Corroboration, ModalBijection};
...
/// [`rename_mapping`] and the tally [`corroboration::ModalBijection`] folds.
