...
.cluster-card__cost{font-family:var(--font-mono);font-size:0.75rem;color:var(--secondary-fixed-dim);text-transform:uppercase;letter-spacing:0.08em;min-width:0;overflow-wrap:anywhere;}\
