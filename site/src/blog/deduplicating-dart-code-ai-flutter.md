...
Yes. Dart is a first-class language today, parsed with tree-sitter alongside C#, Rust, Python, JavaScript, TypeScript, PHP, F#, and Go. Java and C/C++ are on the roadmap.
