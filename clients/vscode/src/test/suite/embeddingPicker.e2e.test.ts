...
// Runs against the real deslop-lsp binary; the LSP forwards embedding/listModels
// to the real stub + ollama providers in deslop-core.
...
suite("embedding picker", () => {
  ...
  test("picker can be invoked without throwing", async () => {
    const p = vscode.commands.executeCommand("deslop.pickEmbeddingModel");
